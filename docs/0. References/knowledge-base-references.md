# Knowledge Base 资料来源参考

> 本文档整理了围绕 Wrkr Payday Super Clearing House 产品构建 knowledge base 时应参考的网站和资源。
...
| 标题 | 日期 | 说明 |
|------|------|------|
| The ATO SBSCH Transition Guide | 2026-06-23 | 从 ATO 小企业清算所迁移的步骤指南 |
| The Small Business Guide to Payday Super | 2026-06-22 | 小企业 Payday Super 综合指南 |
| Paying Super for Contractors in Australia with Wrkr | 2026-06 | Contractor super 义务和 Wrkr 解决方案 |
| Making your first Super Contribution post the ATO Clearing House | 2026-05-25 | ATO 清算所关闭后首次缴纳指南 |
| The SBSCH is closing | 2026-05-12 | ATO 小企业清算所关闭通知 |
| Payday Super – ATO SBSCH Closing | 2026-04-29 | 2026年7月变化概述 |
| Navigating the New Payday Super Rules | 2024-10-30 | 小企业需要了解的规则 |
...
| CPA Australia | https://www.cpaaustralia.com.au | 会计师视角的 super 合规指南 |
...
| 平台 | URL | 说明 |
|------|-----|------|
| Xero | https://www.xero.com/au/ | 主流云会计，可能与 Wrkr 集成 |
| MYOB | https://www.myob.com/au | 澳洲本地主流会计软件 |
| KeyPay | https://www.keypay.com.au | 云端 payroll 引擎 |
| Microkeeper | https://www.microkeeper.com.au | 小企业 payroll |
| Payroller | https://www.payroller.com.au | 免费 STP payroll 工具 |

> 💡 Wrkr 官方提到 "如果你的 payroll provider 已经与我们集成"，具体集成列表参见其注册指南。
...
4. 技术标准 → SuperStream / STP / NPP
   理解数据交换格式和合规技术要求

5. 竞品分析 → SuperChoice / Beam / Xero / MYOB
   理解市场格局和差异化定位

6. 用户视角 → ICB / Australian Payroll Association
   理解 bookkeeper 和 payroll 专业人士的实际工作流
```
